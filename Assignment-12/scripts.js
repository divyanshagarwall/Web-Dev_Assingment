...
function setGreeting() {
  ...
  if (hour < 12) {
    document.body.style.backgroundImage =
      'url("https://images.pexels.com/photos/163255/sunrise-sun-morgenrot-skies-163255.jpeg?cs=srgb&dl=pexels-pixabay-163255.jpg&fm=jpg")';
    greeting.innerHTML = "Good Morning";
  } else if (hour < 18) {
    document.body.style.backgroundImage =
      'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrt0gelLr3A2k-wlec24GiHDpFjadR4kP7BA&usqp=CAU")';
    greeting.innerHTML = "Good Afternoon";
  } else {
    document.body.style.backgroundImage =
      'url("https://images.pexels.com/photos/12376102/pexels-photo-12376102.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")';
